...
/**
 * @fileOverview Summarizes a news article using AI.
 *
...
const SummarizeArticleInputSchema = z.object({
  articleText: z.string().describe('The full text content of the news article to summarize.'),
});
